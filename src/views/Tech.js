...
export default class Tech extends React.Component {
    ...
    componentDidMount() { 
        fetch("https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=b3330c3c691f41f1b55ad02c7bbabbf9")
    ...
    renderItem = (data) => {
        return (
            <Article data={data} theme={"red"} navigation={this.props.navigation}/>
        )
    }
