...
export default class Google extends React.Component {
    ...
    componentDidMount() {
        fetch("https://newsapi.org/v2/top-headlines?q=google&sortBy=popularity&apiKey=b3330c3c691f41f1b55ad02c7bbabbf9")
    ...
    renderItem = (data) => {
        return (
             <Article data={data} theme={"purple"} navigation={this.props.navigation}/>
        )
    }
